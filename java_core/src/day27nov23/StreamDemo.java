...
public class StreamDemo {
	public static void main(String[] args) {
		...
		List<String> sal = new ArrayList<>();
			...
			System.out.println("Print names whoes name starts with R and length is > 5 ----->");
				sal.stream().filter(x->x.startsWith("R"))
				.filter(x->x.length()>5)
				.forEach(System.out::println);
				...
				System.out.println("Print name in upper case------------>");
				...
				System.out.println("Print names in sorted distinct order in upper case----------->");
				...
				a1.stream().map(x->x*x).forEach(x->System.out.println(x));
				...
				System.out.println("Find square of every no and store ArrayList:-------->");
				List<Integer> l1 = a1.stream().map(x->x*x).collect(Collectors.toList());
				System.out.println("l1="+l1);
				
				System.out.println("Replace character R to Z and print------>");
				...
				Integer sum = a1.stream().reduce(1,(n1,n2)->n1+n2);
				System.out.println("sum = " + sum);
				
				System.out.println("Find a length of every string-------->");
				...
				System.out.println("Find out min from a list------------>");
				...
				//System.out.println(minFromList1.get());
				//java.util.NoSuchElementException: No value present when list is empty
				 // to avoid this use orElse
				
				System.out.println(minFromList1.orElse(-1)); //-1
				
				System.out.println("Find a max even no from a list of integers------>");
...
//				System.out.println("ol1.orElse() " + ol1.get()); //No SuchElementException
